...
const Home = () => {
  ...
  <img src={ac3} id="img" alt="img"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <button class="ui blue button"onClick={hostel}>Rajeshwari</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <button class="ui blue button"onClick={hostel}>Srujana</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <button class="ui blue button"onClick={hostel}>Sadhana</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <button class="ui blue button"onClick={hostel}>Medha</button>
       <br/>
  ...
  <img src={ac3} id="img" alt="img"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <button class="ui blue button"onClick={hostel}>Rajeshwari </button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <button class="ui blue button"onClick={srujana}>Neelima</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <button class="ui blue button"onClick={srujana}>Narmada</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <button class="ui blue button"onClick={srujana}>Green Meadows</button><br/>
        <div className='form'>
